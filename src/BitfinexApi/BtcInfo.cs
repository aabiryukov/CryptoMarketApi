...
namespace Bitfinex
{
   public static class BtcInfo
   {
      static BtcInfo()
      {
         ...
         {
	         {ExchangeSymbolEnum.btc, ExchangeSymbolNameEnum.bitcoin},
	         {ExchangeSymbolEnum.ltc, ExchangeSymbolNameEnum.litecoin},
	         {ExchangeSymbolEnum.drk, ExchangeSymbolNameEnum.darkcoin}
         };
      }
